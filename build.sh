...
# otherwise PZ keeps loading the older bytes (and any .zbs sidecar lives in the
# wrong place). Set WORKSHOP_STAGE_MOD in build.local to point at the
# Contents/mods/<Mod> dir; the parent (with workshop.txt/preview.png) is preserved.
