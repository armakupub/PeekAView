...
-- Opt-in: the workaround alters rendering of player-built tiles at
-- vanilla facades even for players the bug never hits. Persistence
-- key bumped from "fixB42" so existing installs (where it was
-- default-on and mostly never consciously chosen) reset to off.
